...
import com.example.android.camera2video.camera.CameraImpl;
...
public class CameraManager {
    ...
    public void setCallback(TakePhotoCallback callback) {
    ...
    public CameraManager(Context context, AutoFitTextureView textureView, int cameraId) {
        mContext = context;
...
//            String cameraId = manager.getCameraIdList()[0];
            String cameraId = String.valueOf(mOpenCameraId);
            ...
            Log.d("wxn", "size=" + mPreviewSize.getWidth());
            Log.d("wxn", "size d= " + mPreviewSize.getHeight());
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        Log.d("wxn", "m=" + mNextVideoAbsolutePath);
